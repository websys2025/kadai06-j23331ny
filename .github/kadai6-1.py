...
APP_ID = "3d6102de401694b03e75dd1f3e8904ed222d4c94"# e-Stat API アプリケーションID
API_URL  = "https://api.e-stat.go.jp/rest/3.0/app/json/getStatsData"# e-Stat API のエンドポイント：統計データ取得用

params = {
    "appId": "3d6102de401694b03e75dd1f3e8904ed222d4c94",
    "statsDataId":"0003283047",#交通事故発生状況の統計表ID
    "metaGetFlg":"Y",
    "cntGetFlg":"N",
    "explanationGetFlg":"Y",
    "annotationGetFlg":"Y",
